        ...
        <div className='App-message'>{state.message}</div>
        {
            state.showLogin &&
                <div className='App-dialog'>
                    ...
                    <button onClick={() => dispatch({type: 'LOGIN', payload: password})}>Login</button>
                    <button onClick={() => dispatch({type: 'CANCEL_DELETION'})}>Cancel</button>
        ...
        }
        {
            state.showConfirmation &&
                <div className='App-dialog'>
                    ...
                    <button onClick={() => dispatch({type: 'CONFIRM_DELETION'})}>Yes</button>
                    <button onClick={() => dispatch({type: 'CANCEL_DELETION'})}>No</button>
                </div>
        }
        {
            state.showResult &&
