...
describe('undo', () => {
    it('should work like the reducer for most things', () => {
        ...
        expect(state.items).toEqual([null, '2', '3', '1', '5', '6', '7', '8', '4'])
    });
    it('should be able to undo an action', () => {
        ...
        expect(state.items).toEqual(['2', null, '3', '1', '5', '6', '7', '8', '4'])
        ...
        expect(state.items).toEqual(['1', '2', '3', null, '5', '6', '7', '8', '4'])
    ...
    it('should be able to redo an action', () => {
        ...
        expect(state.items).not.toEqual(['1', '2', '3', null, '5', '6', '7', '8', '4'])
